<div class="main-table">
    <div class="detail-table">
      <div class="cardHeader">
        ...
        <a href="brand/form_add" class= "btn btn-primary btn-sm">
              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-action">
                    <a href="brand/form_update/<?php echo $row["MAHANGSX"];?>" class="btn-edit" id ="btn_edit">
                    <ion-icon name="create-outline"></ion-icon></a>
                    <button key="<?php echo $row["MAHANGSX"];?>"
