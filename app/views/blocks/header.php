<div class="header">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top header">
    <div class="container-fluid">
      <a class="navbar-brand" href="<?php echo _WEB_ROOT; ?>"><img src="<?php echo _WEB_ROOT; ?>/public/assets/clients/images/logo.jpg" alt=""></a>
      ...
      <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="<?php echo _WEB_ROOT; ?>">TRANG CHỦ</a>
          </li>
          <li class="nav-item">
        ...
        <form class="d-flex" method="POST"  action="index.php?go=search_submit" >
          <input class="form-control me-2" id = "nav_search" type="text" name="search" placeholder="Search">
        ...
        <div class="nav-icon">
            <a class="navbar-brand icon" href="<?php echo _WEB_ROOT; ?>/cart" style="position:relative;"><i class="fa fa-shopping-cart" >
              <?php if (isset($_SESSION['soluong'])) { ?>
                  <p style="width:fit-content;text-align: center;font-size:small;color: #fff;position: absolute;right: -10px; top: 3px;"><?php echo $_SESSION[
                      'soluong'
                  ]; ?></p>
                <?php if ($_SESSION['soluong'] == 0) {
                    unset($_SESSION['soluong']);
                }} ?>
              </i>
            </a>
            <?php if (isset($_SESSION['user'])) { ?>
                  <a class="navbar-brand icon" href="<?php echo _WEB_ROOT .
